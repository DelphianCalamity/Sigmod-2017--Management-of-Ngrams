...
void topK_Hashtable_init_bucket(TopK_Bucket*, char*, int);
...
void topK_Hashtable_insert(TopK_Hashtable_Info_ptr, char*, int, int);
void topK_Hashtable_merge(TopK_Hashtable_Info_ptr, TopK_Hashtable_Info_ptr);
void topK_Hashtable_insert_child(TopK_Hashtable_Info_ptr, Big_Bucket*, char*, int);
...
void topK_Hashtable_Partial_Destroy(TopK_Hashtable_Info_ptr);
#endif
